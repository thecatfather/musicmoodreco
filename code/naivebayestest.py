...
if __name__ == '__main__':
    predictorPickleName = 'naivebayes.pkl'
    tfidfpickle = 'tfidf.pkl'
    clf = loadPickle(predictorPickleName)
    tfidf =loadPickle(tfidfpickle)
    # np.random.seed(1337)
    ...
    if TRAIN:
        ...
        utils.save_results_to_csv(predictions, 'naivebayes1.csv')
        print ('\nSaved to naivebayes1.csv')
    #predictorPickleName = 'naivebayes.pkl'
    #dumpPickle(predictorPickleName, clf)